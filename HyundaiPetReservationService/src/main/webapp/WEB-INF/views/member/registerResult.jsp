					...
					<div class="join-complete-wrap">
						<div class="header-block">
							...
							<h3>
								...
								로 가입해주셨습니다. 가입하신 아이디와 비밀번호로 안전하게 로그인 하실 수 있습니다.
							</h3>
						</div>
						<div class="title-block">
							<h3>&#8251 이메일, 카카오톡, 페이스북, 구글 계정을 통해 간편가입시 개인정보(이메일, 아이디,
								성명, 휴대폰 번호 등)을 간접 수집합니다.</h3>
						...
						<div class="btn-group mt40">
							<a href="/thepet/main" class="btn btn-lg btn-white"> <span>더
									현대닷컴 메인으로 > </span>
							</a>
						</div>
					</div>
