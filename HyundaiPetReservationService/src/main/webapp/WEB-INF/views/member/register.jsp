...
<link rel="stylesheet" href="/thepet/resources/basic/css/container.css?<%= System.currentTimeMillis() %>">
<link rel="stylesheet" href="/thepet/resources/member/css/register.css?<%= System.currentTimeMillis() %>">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
<script src="/thepet/resources/member/js/register.js?<%= System.currentTimeMillis() %>"></script>
							...
							<div class="xans-element- xans-member xans-member-join">
								...
								<div class="join-block">
									<fieldset>
										...
										<div>
											<div class="form-block">
												<label class="ePlaceholderEach required" title="비밀번호*">
													...
													name="" autocomplete="off" maxlength="16" value=""
											...
											<div class="form-block">
												<label class="ePlaceholderEach required" title="비밀번호 확인*">
													...
													<input id="user_passwd_confirm" name="password" 
										...
										<div>
											<div class="form-block">
												<label class="ePlaceholderEach required" title="이름*">
													<p class="form-title">이름*</p> <input id="name"
													name="name" placeholder="이름*" maxlength="30" value="" type="text">
										...
										<div class=" ePlaceholderGroup" style="width: 100%;"
											...
											<div class="form-block phone-block flex-column-2">
												<label class="ePlaceholder required">
													...
													<div class="phone">
														<input id="mobile1" name="mobile1" maxlength="4" value="" type="text" oninput="combinePhone()"> - 
														<input id="mobile2" name="mobile2" maxlength="4" value="" type="text" oninput="combinePhone()"> - 
														<input id="mobile3" name="mobile3" maxlength="4" value="" type="text" oninput="combinePhone()">
													</div>
												</label>
											</div>
										</div>
												...
												<div class="birthday">
													<div class="day">
														<label title="생년*" class="ePlaceholderEach">
															...
															<input id="birth_year" name="birth_year" class="inputTypeText" placeholder="생년" maxlength="4" value="" type="text" oninput="combineBirth()">
														</label> 
														<label title="월*" class="ePlaceholderEach">
															<p class="form-title">월*</p> 
															<input id="birth_month" name="birth_month" class="inputTypeText" placeholder="월" maxlength="2" value="" type="text" oninput="combineBirth()">
														</label> 
														<label title="일*" class="ePlaceholderEach">
															<p class="form-title">일*</p> 
															<input id="birth_day" name="birth_day" class="inputTypeText" placeholder="일" maxlength="2" value="" type="text" oninput="combineBirth()">
														</label>
													</div>
												</div>
										...
										<div hidden class="hidden_form" style="border: 2px solid black;">
											<input hidden id="phoneInput" name="phone" >
											<input hidden id="birthInput" name="birth" >
										</div>
									</fieldset>
								</div>
								<button type="button"
