	...
	<div class="add_option_container">
		...
		<div class="add_option_radio_box">
			<div class="radoi_button_box">
				<input type="radio" name="beauty_service_type" id="beauty" class="add_option_radio_input"/>
				<label for="beauty" class="add_option_radio_label">미용</label>
			</div>
			<div class="radoi_button_box">
				<input type="radio" name="beauty_service_type" id="spar" class="add_option_radio_input"/>
