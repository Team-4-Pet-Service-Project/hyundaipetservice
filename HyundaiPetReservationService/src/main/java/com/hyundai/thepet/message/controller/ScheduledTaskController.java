 ...
 * @EnableScheduling
 * 
 * @RequiredArgsConstructor public class ScheduledTaskController { private final
 * SmsController smsController; private final SelectService selectService;
 * 
 * @Scheduled(cron = "0 50 * * * *", zone= "Asia/Seoul") public void
 * runEveryFiftyMinutes() throws InvalidKeyException, JsonProcessingException,
