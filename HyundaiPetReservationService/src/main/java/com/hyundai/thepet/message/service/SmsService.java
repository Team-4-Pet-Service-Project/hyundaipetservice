 ...
 * com.hyundai.thepet.message.dto.SmsRequestDTO; import
 * com.hyundai.thepet.message.dto.SmsResponseDTO;
 * 
 * import lombok.RequiredArgsConstructor; import
 * java.io.UnsupportedEncodingException; import java.net.URI; import
 * java.net.URISyntaxException;
 * 
 * import java.security.InvalidKeyException; import
 * java.security.NoSuchAlgorithmException; import java.util.ArrayList; import
 ...
 * 
 * @Value("${naver-cloud-sms.senderPhone}") private String senderPhone;
 * 
 * 
 * 
 * public String makeSignature(String time) throws NoSuchAlgorithmException,
 * UnsupportedEncodingException, InvalidKeyException { String space = " ";
 * String newLine = "\n"; String method = "POST"; String url =
 * "/sms/v2/services/"+ this.serviceId+"/messages"; String timestamp =
 * time.toString(); String accessKey = this.accessKey; String secretKey =
 * this.secretKey;
 * 
 ...
 * // 현재시간 String time = Long.toString(System.currentTimeMillis());
 * 
 * // 헤더세팅 HttpHeaders headers = new HttpHeaders();
 ...
 * 
 * // body와 header을 합친다 HttpEntity<String> httpBody = new HttpEntity<>(body,
 * headers);
 * 
 * System.out.println(httpBody);
 * 
 * 
 * //restTemplate를 통해 외부 api와 통신 RestTemplate restTemplate = new RestTemplate();
 * restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory());
 * // String encodedServiceId = URLEncoder.encode(serviceId, "UTF-8"); String
 * uri = "https://sens.apigw.ntruss.com/sms/v2/services/" + this.serviceId +
 * "/messages";
 * 
 * SmsResponseDTO smsResponseDto = restTemplate.postForObject(new URI(uri),
